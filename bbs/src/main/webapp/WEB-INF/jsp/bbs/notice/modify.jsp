...
<!-- 게시판 정보 등록 -->
function fn_save(){
	var url = "<c:url value='/notice/update.do'/>"
                ...
                <div class="table_wrap">
                    <table class="st02">
                        ...
                        <tr>
                            <th>제목</th>
                            <td colspan="3">
                                <input type="text" class="inputW1000" name="bdTitle" value="${resultVO.bdTitle}">
                            </td>
                        </tr>
                        <tr>
                            <th>작성자</th>
                            <td>
                                <input type="text" name="bdWriter" value="${resultVO.bdWriter}">
                            </td>
                            <th>상단고정</th>
                            <td>
                            	<c:choose>
                            		<c:when test="${resultVO.fixtop eq '1'}">
                           				<input type="checkbox" name="fixtop" onchange="fn_checked(this)" id="fixtop" checked>
                        ...
                        <tr>
                            <td colspan="4" class="table_text"><textarea name="bdContents">${resultVO.bdContents}</textarea></td>
                        </tr>
                    </table>
